...
export default function MeetingView({auth, session}) {
    ...
    return (
        <AuthenticatedLayout user={auth.user} header="Session Details">
            ...
            <meta http-equiv="origin-trial" content="AiPME2z8Xn/4yQvPcQO51g6IKDVTr5kLUhDWsp5qVnsjYW1YffxLyiSzYRQMw0kRo/8+vtuXoqD70yYn5FCACwEAAABeeyJvcmlnaW4iOiJodHRwOi8vbG9jYWxob3N0OjgwIiwiZmVhdHVyZSI6IlVucmVzdHJpY3RlZFNoYXJlZEFycmF5QnVmZmVyIiwiZXhwaXJ5IjoxNzE5MzU5OTk5fQ=="/>
